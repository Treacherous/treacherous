...
var ISODateValidationRule = (function () {
    ...
    ISODateValidationRule.prototype.validate = function (modelHelper, propertyName) {
    ...
    ISODateValidationRule.prototype.getMessage = function (modelHelper, propertyName) {
        var value = modelHelper.resolve(propertyName);
