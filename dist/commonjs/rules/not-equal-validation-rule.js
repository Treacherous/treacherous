...
var NotEqualValidationRule = (function () {
    ...
    NotEqualValidationRule.prototype.validate = function (modelHelper, propertyName, optionsOrValue) {
    ...
    NotEqualValidationRule.prototype.getMessage = function (modelHelper, propertyName, optionsOrValue) {
        var value = modelHelper.resolve(propertyName);
